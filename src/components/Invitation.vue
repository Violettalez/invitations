      ...
      <div class="max-w-4xl w-full mx-auto">
        ...
        >
          ...
          >
            ...
            заздалегідь (до 01.08.2026), щоб ми могли заздалегідь підготувати
            все для вас. Для підтвердження присутності, вказання кількості
            гостей та потреби в трансфері, будь ласка, зв'яжіться з нами за
            такими контактами:
          </p>
