      ...
      >
        <div class="details p-4 sm:p-6">
          ...
          <p class="text-blue-dark2 text-sm sm:text-base mb-8 sm:mb-12">
            Для всіх охочих буде організовано трансфер з <br />
            м. Південноукраїнськ до місця святкування та назад після завершення
            свята. Автобуси комфортні, тому, якщо вам потрібен трансфер, будь
            ласка, обов'язково зазначте це під час підтвердження своєї
            присутності. Заздалегідь щиро дякуємо!
          </p>
      ...
      <div class="w-full px-4 py-12 sm:py-16">
        <div class="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            якщо під час вибору вбрання ви звернете увагу на кольорову гаму дня:
            <strong>пастельні відтінки блакитного та золотого</strong>. Ми
            неймовірно любимо українські традиції, однак для цього дня ми обрали
    ...
    >
      <div class="max-w-4xl w-full mx-auto">
        ...
        >
          ...
          >
            Дуже будемо вдячні, якщо повідомите наc про вашу присутність
            заздалегідь ( <strong>до 01.08.2026</strong> ), щоб ми могли
            підготувати все для вас. Для підтвердження присутності, вказання
            кількості гостей та потреби в трансфері, будь ласка, зв'яжіться з
            нами за такими контактами:
          </p>
      ...
      <div class="space-y-3 mb-12 sm:mb-18">
        ...
        >
          ...
          <div
            class="mt-[2px] text-xs sm:text-sm md:text-base text-gray-600 leading-relaxed border-t border-gray-100 pt-3 animate-fadeIn p-4"
          >
            Парковка доступна біля ресторану. Також організовано трансфер з
            <br />
            м. Південноукраїнськ. <br />
            Якщо вам потрібен транспорт, будь ласка, попередньо повідомте про
            це.
          </div>
        </details>
